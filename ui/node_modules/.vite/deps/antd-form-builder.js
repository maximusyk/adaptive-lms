...
import "./chunk-EA4T537F.js";
import "./chunk-K72AU2X6.js";
import "./chunk-WMVA2DUJ.js";
import "./chunk-KUDJYGSZ.js";
import "./chunk-6YKC6NEJ.js";
import "./chunk-PK4Y62UW.js";
...
var require_castArray = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/castArray.js"(exports, module) {
    var isArray2 = require_isArray();
    function castArray() {
      if (!arguments.length) {
        return [];
...
// node_modules/.pnpm/antd-form-builder@2.1.4_bc7hidxex7jtstr4ngbiagpbbe/node_modules/antd-form-builder/dist/index.es.js
...
var QuestionIcon = function() {
  return import_react.default.createElement("svg", { viewBox: "0 0 1024 1024", className: "antd-form-builder-question-icon" }, import_react.default.createElement("path", { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z" }), import_react.default.createElement("path", { d: "M623.6 316.7C593.6 290.4 554 276 512 276s-81.6 14.5-111.6 40.7C369.2 344 352 380.7 352 420v7.6c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8V420c0-44.1 43.1-80 96-80s96 35.9 96 80c0 31.1-22 59.6-56.1 72.7-21.2 8.1-39.2 22.3-52.1 40.9-13.1 19-19.9 41.8-19.9 64.9V620c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8v-22.7c0-19.7 12.4-37.7 30.9-44.8 59-22.7 97.1-74.7 97.1-132.5 0.1-39.3-17.1-76-48.3-103.3z" }), import_react.default.createElement("path", { d: "M512 732m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" }));
};
...
var FormItem = form_default.Item;
var isV4 = !!form_default.useForm;
var getValue = function getValue2(obj, namePath) {
  var arr = typeof namePath === "string" ? namePath.split(".") : namePath;
  var current = obj;
  for (var i = 0; i < arr.length; i += 1) {
    if ((0, import_has.default)(current, arr[i])) {
...
var getWrappedComponentWithForwardRef = (0, import_memoize.default)(function(Comp) {
  return (0, import_react.forwardRef)(function(props, ref) {
    return import_react.default.createElement("span", { ref }, import_react.default.createElement(Comp, props));
  });
});
function FormBuilderField(props) {
  var field = props.field, meta = props.meta, form = props.form;
  var label = field.tooltip ? import_react.default.createElement("span", null, field.label, import_react.default.createElement(tooltip_default, { title: field.tooltip }, " ", import_react.default.createElement(QuestionIcon, null))) : field.label;
  var formItemLayout = field.formItemLayout || (field.label ? getValue(meta, "formItemLayout") || [8, 16] : null);
  if ((0, import_isArray.default)(formItemLayout) && formItemLayout.length >= 2) {
    formItemLayout = {
  ...
  var formItemProps = _extends({
    ...
    label
  }, (0, import_pick.default)(field, ["help", "extra", "labelCol", "wrapperCol", "colon", "htmlFor", "noStyle", "validateStatus", "hasFeedback"]), field.formItemProps, {
  ...
  if (isV4) {
    ...
    }, (0, import_pick.default)(field, ["shouldUpdate", "dependencies"])));
  }
  ...
  if (field.render) {
    return field.render.call(this, _extends({
      ...
      field,
      form
    }, (0, import_pick.default)(props, ["disabled", "viewMode", "initialValues"])));
  }
  var initialValue = void 0;
  var initialValues = meta.initialValues || {};
  if ((0, import_has.default)(field, "initialValue")) {
  ...
  if (field.required) {
    rules.unshift({ required: true, message: field.message || field.requiredMessage || void 0 });
  }
  var fieldProps = _extends({
    initialValue,
    preserve: meta.preserve
  }, (0, import_pick.default)(field, ["getValueFromEvent", "getValueProps", "normalize", "trigger", "preserve", "valuePropName", "validateTrigger", "validateFirst"]), {
    rules
  }, field.fieldProps);
  if (isV4) {
  ...
  if (isFieldViewMode) {
    ...
    var viewValue = (0, import_has.default)(formValues, field.key || field.name.join(".")) ? getValue(formValues, formItemProps.name || field.key) : initialValue;
    if (field.renderView) {
      viewEle = field.renderView(viewValue, form, initialValues);
    } else if (field.viewWidget) {
      var ViewWidget = field.viewWidget;
      viewEle = import_react.default.createElement(ViewWidget, _extends({ value: viewValue, form, field }, field.viewWidgetProps));
    } else if (field.link) {
      var href = typeof field.link === "string" ? field.link : viewValue;
      viewEle = import_react.default.createElement("a", { href, target: field.linkTarget || "_self" }, viewValue);
    } else if (field.options) {
      var found = (0, import_find.default)(field.options, function(opt) {
    ...
    if (!viewEle) {
      if (typeof viewValue === "boolean")
        viewEle = (0, import_capitalize.default)(String(viewValue));
      else if (viewValue === void 0)
        viewEle = "N/A";
      else {
        viewEle = import_react.default.createElement("span", { className: "antd-form-builder-string-content" }, String(viewValue) || "");
      }
    }
    if (form && field.readOnly) {
      var _ele = import_react.default.createElement("span", { className: "antd-form-builder-read-only-content" }, viewEle);
      return import_react.default.createElement(FormItem, formItemProps, isV4 ? _ele : form.getFieldDecorator(field.id || field.key, fieldProps)(_ele));
    }
    delete formItemProps.name;
    delete formItemProps.key;
    return import_react.default.createElement(FormItem, formItemProps, viewEle);
  }
  var wp = field.widgetProps || {};
  var widgetProps = _extends({}, (0, import_pick.default)(field, ["placeholder", "type", "className", "class", "onChange"]), {
    disabled: field.disabled || meta.disabled || props.disabled
  }, wp);
  var FieldWidget = field.widget || input_default;
  if (field.forwardRef) {
    FieldWidget = getWrappedComponentWithForwardRef(FieldWidget);
  }
  var valueProps = {};
  var ele = import_react.default.createElement(FieldWidget, _extends({}, widgetProps, valueProps), field.children || null);
  var ele2 = isV4 ? ele : form.getFieldDecorator(field.id || field.key, fieldProps)(ele);
  if (isV4) {
    return import_react.default.createElement(FormItem, formItemProps, ele);
  }
  return field.noFormItem || field.noStyle ? ele2 : import_react.default.createElement(FormItem, formItemProps, ele2);
}
...
styleInject(css);
var isV4$1 = !!form_default.useForm;
var widgetMap = {};
...
function normalizeMeta(meta) {
  var fields = (0, import_isArray.default)(meta) ? meta : meta.fields || meta.elements;
  if (!fields)
    fields = [meta];
  fields = fields.map(function(field) {
    ...
    var item = (0, import_find.default)(Object.values(widgetMap), function(entry) {
    ...
    if (item) {
      ...
      return _extends({}, newField, { viewWidget, widget, dynamic });
    }
    return _extends({}, field, { widget, viewWidget, dynamic });
  });
  if ((0, import_isArray.default)(meta) || !meta.fields && !meta.elements) {
    return { fields };
  }
...
function FormBuilder(props) {
  var getMeta = props.getMeta, form = props.form;
  var meta = getMeta ? getMeta(form, props) : props.meta;
  return import_react.default.createElement(FormBuilderInner, _extends({}, props, { form: form ? form.current || form : null, meta }));
}
function FormBuilderInner(props) {
  var meta = props.meta, viewMode = props.viewMode, initialValues = props.initialValues, _props$disabled = props.disabled, disabled = _props$disabled === void 0 ? false : _props$disabled, _props$form = props.form, form = _props$form === void 0 ? null : _props$form;
  if (!meta)
    return null;
  ...
  var fields = newMeta.fields, _newMeta$columns = newMeta.columns, columns = _newMeta$columns === void 0 ? 1 : _newMeta$columns, _newMeta$gutter = newMeta.gutter, gutter = _newMeta$gutter === void 0 ? 10 : _newMeta$gutter;
  var elements = fields.map(function(field) {
    return import_react.default.createElement(FormBuilderField, {
      key: field.key,
      field,
      disabled,
      meta: newMeta,
  ...
  for (var i = 0; i < elements.length; ) {
    var cols = [];
    for (var j = 0; (j < columns || j === 0) && i < elements.length && (!["left", "both"].includes(fields[i].clear) || j === 0); ) {
      var fieldSpan = fields[i].colSpan || 1;
      cols.push(import_react.default.createElement(col_default, { key: j, span: Math.min(24, spanUnit * fieldSpan) }, elements[i]));
      j += fieldSpan;
    ...
    rows.push(import_react.default.createElement(row_default, { key: i, gutter }, cols));
  }
  return rows;
}
FormBuilder.defineWidget = function(name, widget) {
  var metaConvertor = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
  if (widgetMap[name])
    throw new Error('Widget "' + name + '" already defined.');
  widgetMap[name] = {
    widget,
    metaConvertor
  };
...
FormBuilder.useForceUpdate = function() {
  var _React$useState = import_react.default.useState(), _React$useState2 = slicedToArray(_React$useState, 2), updateState = _React$useState2[1];
  var forceUpdate = import_react.default.useCallback(function() {
    return updateState({});
  }, []);
  return forceUpdate;
};
...
FormBuilder.propTypes = {
  meta: import_prop_types.default.any
};
var mapOptions = function mapOptions2(options) {
  if (!import_lodash.default.isArray(options)) {
    throw new Error("Options should be array in form builder meta.");
  }
  return options.map(function(opt) {
    if (import_lodash.default.isArray(opt)) {
      return { value: opt[0], label: opt[1] };
    } else if (import_lodash.default.isPlainObject(opt)) {
      return opt;
    } else {
...
FormBuilder.defineWidget("checkbox", checkbox_default, function(field) {
  return _extends({}, field, { valuePropName: "checked" });
});
FormBuilder.defineWidget("switch", switch_default, function(field) {
  return _extends({}, field, { valuePropName: "checked" });
});
FormBuilder.defineWidget("button", button_default);
FormBuilder.defineWidget("input", input_default);
FormBuilder.defineWidget("password", input_default.Password);
FormBuilder.defineWidget("textarea", input_default.TextArea);
FormBuilder.defineWidget("number", input_number_default);
FormBuilder.defineWidget("date-picker", date_picker_default);
FormBuilder.defineWidget("radio", radio_default);
FormBuilder.defineWidget("radio-group", radio_default.Group, function(field) {
  var RadioComp = field.buttonGroup ? radio_default.Button : radio_default;
  if (field.options && !field.children) {
    return _extends({}, field, {
      ...
      children: mapOptions(field.options).map(function(opt) {
        return import_react.default.createElement(RadioComp, { value: opt.value, key: opt.value }, opt.label);
      })
    });
  }
  return field;
});
FormBuilder.defineWidget("checkbox-group", checkbox_default.Group, function(field) {
  if (field.options && !field.children) {
    return _extends({}, field, {
      children: mapOptions(field.options).map(function(opt) {
        return import_react.default.createElement(checkbox_default, { value: opt.value, key: opt.value }, opt.label);
      })
    });
  }
  return field;
});
FormBuilder.defineWidget("select", select_default, function(field) {
  if (field.options && !field.children) {
    return _extends({}, field, {
      children: mapOptions(field.options).map(function(opt) {
        return import_react.default.createElement(select_default.Option, { label: opt.label, value: opt.value, key: opt.value, disabled: opt.disabled }, opt.children || opt.label);
      })
    });
  }
  return field;
});
var index_es_default = FormBuilder;

// dep:antd-form-builder
var antd_form_builder_default = index_es_default;
export {
  antd_form_builder_default as default
};
/**
 * @license
 ...
 */
//# sourceMappingURL=antd-form-builder.js.map
